...
async function main() {
  ...
  console.log("=== Testing Migration Chain Replay on Clean Schema (0001 -> 0002 -> 0003 -> 0004) ===");
  const testSchema = "ats_test_clean_0004";
  ...
  console.log("=== SUCCESS: Full migration chain 0001 -> 0002 -> 0003 -> 0004 replays with ZERO DIFF! ===");
